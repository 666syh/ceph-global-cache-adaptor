...
void RadosWriteOpWriteSameSGL(rados_op_t op, const SGL_S *s,
				size_t dataLen, size_t writeLen, uint64_t off, int isRelease);
...
void RadosReadOpReadSGL(rados_op_t op, uint64_t offset, size_t len, SGL_S *s, int *prval, int isRelease);
